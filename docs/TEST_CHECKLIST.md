...
- [x] UI 文字使用原版 `FontRenderer`；蟹笼 20 个实际槽和商人物品槽直接裁取原版 `generic_54.png`，商人/交通面板直接使用原版 `demo_background.png`，没有 `drawRect` 仿制槽框或凸起边框。PASS：源码审查、`compileJava`、`build` 与 Forge audit。
