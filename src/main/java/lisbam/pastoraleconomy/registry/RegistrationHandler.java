...
public final class RegistrationHandler {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(ModBlocks.VILLAGE_STATION, ModBlocks.CRAB_TRAP, ModBlocks.SHIPPING_BOX,
                ModBlocks.TRANSPORT_STATION, ModBlocks.CHUNK_LOADER);
    }
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(ModItems.BACKPACK, ModItems.ADVANCED_BACKPACK, ModItems.SUPER_BACKPACK,
                ...
                ModItems.CRAB_TRAP_ITEM, ModItems.SHIPPING_BOX_ITEM, ModItems.TRANSPORT_STATION_ITEM,
