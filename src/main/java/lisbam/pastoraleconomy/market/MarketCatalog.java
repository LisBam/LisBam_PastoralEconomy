...
public final class MarketCatalog {
    ...
    private static void addSellingDefinitions(Map<String, MarketCommodity> definitions) {
        ...
        add(definitions, "sell/crop/carrot", Items.CARROT, 0, 50, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/potato", Items.POTATO, 0, 40, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/beetroot", Items.BEETROOT, 0, 70, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/pumpkin", block(Blocks.PUMPKIN), 0, 170, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/melon_block", block(Blocks.MELON_BLOCK), 0, 250, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/melon_slice", Items.MELON, 0, 30, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/sugar_cane", Items.REEDS, 0, 40, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/cactus", block(Blocks.CACTUS), 0, 30, CommodityCategory.CORE_CROPS, true);
        add(definitions, "sell/crop/cocoa_beans", Items.DYE, 3, 50, CommodityCategory.SECONDARY_AGRICULTURE_LIVESTOCK, true);
        ...
        add(definitions, "sell/agriculture/apple", Items.APPLE, 0, 100, CommodityCategory.SECONDARY_AGRICULTURE_LIVESTOCK, true);
        ...
        add(definitions, "sell/livestock/leather", Items.LEATHER, 0, 120, CommodityCategory.SECONDARY_AGRICULTURE_LIVESTOCK, true);
        add(definitions, "sell/livestock/rabbit_hide", Items.RABBIT_HIDE, 0, 60, CommodityCategory.SECONDARY_AGRICULTURE_LIVESTOCK, true);
        add(definitions, "sell/livestock/rabbit_foot", Items.RABBIT_FOOT, 0, 200, CommodityCategory.SECONDARY_AGRICULTURE_LIVESTOCK, true);
        ...
        for (int metadata = 0; metadata < 16; metadata++) {
            add(definitions, "sell/livestock/wool_" + metadata, block(Blocks.WOOL), metadata, 80,
    ...
    private static void addCommonAndRarePurchaseDefinitions(Map<String, MarketCommodity> definitions) {
        ...
        add(definitions, "buy/common/beetroot_seeds", Items.BEETROOT_SEEDS, 0, 960, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/pumpkin_seeds", Items.PUMPKIN_SEEDS, 0, 1200, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/melon_seeds", Items.MELON_SEEDS, 0, 1200, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/cocoa_beans", Items.DYE, 3, 1200, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/sugar_cane", Items.REEDS, 0, 800, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/cactus", block(Blocks.CACTUS), 0, 800, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/red_mushroom", block(Blocks.RED_MUSHROOM), 0, 1200, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/brown_mushroom", block(Blocks.BROWN_MUSHROOM), 0, 1200, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/bone_meal", Items.DYE, 15, 1800, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/nether_wart", Items.NETHER_WART, 0, 4000, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
        add(definitions, "buy/common/chorus_flower", block(Blocks.CHORUS_FLOWER), 0, 5000, CommodityCategory.SEEDS_AND_AGRICULTURAL_SUPPLIES, false);
    ...
    private static void addLogsAndBuildingMaterials(Map<String, MarketCommodity> definitions) {
        ...
        for (int metadata = 0; metadata < names.length; metadata++) {
            ...
            add(definitions, "buy/common/log_" + names[metadata], block(log), logMetadata, 500,
        ...
        add(definitions, "buy/common/granite", block(Blocks.STONE), 1, 480, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/andesite", block(Blocks.STONE), 5, 480, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/diorite", block(Blocks.STONE), 3, 480, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/sand", block(Blocks.SAND), 0, 240, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/red_sand", block(Blocks.SAND), 1, 640, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/gravel", block(Blocks.GRAVEL), 0, 400, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/clay_ball", Items.CLAY_BALL, 0, 480, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/glass", block(Blocks.GLASS), 0, 400, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/ice", block(Blocks.ICE), 0, 400, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/packed_ice", block(Blocks.PACKED_ICE), 0, 1600, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
        add(definitions, "buy/common/snow", block(Blocks.SNOW), 0, 320, CommodityCategory.BASIC_BUILDING_MATERIALS, false);
    ...
    private static void addCommonResources(Map<String, MarketCommodity> definitions) {
        Object[][] resources = {
                ...
                {"iron_ingot", Items.IRON_INGOT, 0, 900}, {"redstone", Items.REDSTONE, 0, 2400},
                {"lapis_lazuli", Items.DYE, 4, 2800}, {"flint", Items.FLINT, 0, 1600},
                {"bone", Items.BONE, 0, 2400}, {"string", Items.STRING, 0, 2400},
                {"spider_eye", Items.SPIDER_EYE, 0, 1600}, {"rotten_flesh", Items.ROTTEN_FLESH, 0, 1600},
                {"ink_sac", Items.DYE, 0, 1600}, {"netherrack", block(Blocks.NETHERRACK), 0, 960},
                {"soul_sand", block(Blocks.SOUL_SAND), 0, 2000}, {"egg", Items.EGG, 0, 800},
    ...
    private static void addRareResources(Map<String, MarketCommodity> definitions) {
        Object[][] resources = {
                {"gold_ingot", Items.GOLD_INGOT, 0, 8000}, {"lava_bucket", Items.LAVA_BUCKET, 0, 6000},
                {"gunpowder", Items.GUNPOWDER, 0, 4000}, {"slime_ball", Items.SLIME_BALL, 0, 4800},
                {"magma_cream", Items.MAGMA_CREAM, 0, 6400}, {"glowstone_dust", Items.GLOWSTONE_DUST, 0, 4800},
                {"nether_quartz", Items.QUARTZ, 0, 4800}, {"end_stone", block(Blocks.END_STONE), 0, 3200},
                {"prismarine_shard", Items.PRISMARINE_SHARD, 0, 4000}, {"prismarine_crystals", Items.PRISMARINE_CRYSTALS, 0, 4000},
    ...
    private static void addRareAndTreasurePurchaseDefinitions(Map<String, MarketCommodity> definitions) {
        Object[][] advanced = {
                {"diamond", Items.DIAMOND, 0, 16000}, {"emerald", Items.EMERALD, 0, 7000},
        ...
        Object[][] rare = {
                ...
                {"sponge", block(Blocks.SPONGE), 0, 50000}, {"chainmail_helmet", Items.CHAINMAIL_HELMET, 0, 15000},
                {"chainmail_chestplate", Items.CHAINMAIL_CHESTPLATE, 0, 25000}, {"chainmail_leggings", Items.CHAINMAIL_LEGGINGS, 0, 22000},
                {"chainmail_boots", Items.CHAINMAIL_BOOTS, 0, 12000}, {"iron_horse_armor", Items.IRON_HORSE_ARMOR, 0, 20000},
                {"golden_horse_armor", Items.GOLDEN_HORSE_ARMOR, 0, 25000}, {"saddle", Items.SADDLE, 0, 18000},
                {"coal_ore", block(Blocks.COAL_ORE), 0, 4000}, {"iron_ore", block(Blocks.IRON_ORE), 0, 5000},
                {"gold_ore", block(Blocks.GOLD_ORE), 0, 10000}, {"redstone_ore", block(Blocks.REDSTONE_ORE), 0, 8000},
                {"lapis_ore", block(Blocks.LAPIS_ORE), 0, 9000}, {"quartz_ore", block(Blocks.QUARTZ_ORE), 0, 7000},
                {"experience_bottle", Items.EXPERIENCE_BOTTLE, 0, 12000}, {"name_tag", Items.NAME_TAG, 0, 10000},
        ...
        Object[][] treasures = {
                ...
                {"elytra", Items.ELYTRA, 0, 1200000}, {"dragon_head", Items.SKULL, 5, 100000},
                {"dragon_egg", block(Blocks.DRAGON_EGG), 0, 2500000}, {"diamond_horse_armor", Items.DIAMOND_HORSE_ARMOR, 0, 60000},
                {"diamond_ore", block(Blocks.DIAMOND_ORE), 0, 30000}, {"emerald_ore", block(Blocks.EMERALD_ORE), 0, 25000},
