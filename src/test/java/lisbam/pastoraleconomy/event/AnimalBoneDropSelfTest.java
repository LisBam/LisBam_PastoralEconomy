...
public final class AnimalBoneDropSelfTest {
    ...
    public static void main(String[] args) {
        require(AnimalBoneDropRules.rollLargeAnimalBaseCount(new FixedRandom(0)) == 2,
                "large animals roll two bones below 40 of 300");
        require(AnimalBoneDropRules.rollLargeAnimalBaseCount(new FixedRandom(39)) == 2,
                "large animals roll two bones at 39 of 300");
        require(AnimalBoneDropRules.rollLargeAnimalBaseCount(new FixedRandom(40)) == 1,
                "large animals roll one bone at 40 of 300");
        require(AnimalBoneDropRules.rollLargeAnimalBaseCount(new FixedRandom(139)) == 1,
                "large animals roll one bone at 139 of 300");
        require(AnimalBoneDropRules.rollLargeAnimalBaseCount(new FixedRandom(140)) == 0,
                "large animals fail at 140 of 300");
        require(AnimalBoneDropRules.rollSmallAnimalBaseCount(new FixedRandom(49)) == 1,
                "small animals roll one bone below 50 of 300");
        require(AnimalBoneDropRules.rollSmallAnimalBaseCount(new FixedRandom(50)) == 0,
                "small animals fail at 50 of 300");
